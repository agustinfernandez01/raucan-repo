...
type FormState = {
  ...
  telefono: string;
  direccion: string;
  rol: 'usuario' | 'administrador' | 'moderador';
  password: string;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post(
        'http://127.0.0.1:8000/usuarios/post',
        payload,
                ...
                >
                  {showPassword ? (
                    ...
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.477 10.485a3 3 0 104.243 4.243" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6.228 6.228C4.6 7.63 3.35 9.65 2.458 12c1.274 4.057 5.064 7 9.542 7 1.253 0 2.45-.23 3.56-.66M14.12 9.88A3 3 0 009.88 14.12" />
                    </svg>
                  ) : (
                    // eye
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative">
                ...
                >
                  {showConfirmPassword ? (
                    ...
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3l18 18" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6.228 6.228C4.6 7.63 3.35 9.65 2.458 12c1.274 4.057 5.064 7 9.542 7 1.253 0 2.45-.23 3.56-.66" />
                    </svg>
                  ) : (
                    // eye
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
