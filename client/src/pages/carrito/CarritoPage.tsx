...
function CarritoItemCard({
  ...
  return (
    <article className="flex flex-wrap gap-4 p-5 bg-white rounded-[18px] shadow-[0_4px_20px_rgba(0,0,0,0.07)] hover:shadow-[0_12px_40px_rgba(136,150,252,0.18)] hover:-translate-y-0.5 transition-all duration-200">
      <div className="w-24 h-24 shrink-0 rounded-xl bg-gradient-to-br from-raucan-rosa/25 to-raucan-lavanda/20 flex items-center justify-center overflow-hidden">
      ...
      <div className="flex-1 min-w-0">
        <h3 className="font-extrabold text-raucan-gris text-[15px] leading-tight truncate">
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#e8e8ec] to-[#dfe0e5]" style={{ fontFamily: "'Nunito', 'Segoe UI', sans-serif" }}>
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        <aside className="bg-white rounded-[18px] shadow-[0_4px_20px_rgba(0,0,0,0.07)] p-6 sticky bottom-4">
